        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAvatarUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    Rating = table.Column<int>(type: "integer", nullable: false),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Body = table.Column<string>(type: "text", nullable: true),
                    VendorReply = table.Column<string>(type: "text", nullable: true),
                    VendorRepliedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "uuid", nullable: false),
                    DealId = table.Column<Guid>(type: "uuid", nullable: false),
                    DealTitle = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    DealOptionId = table.Column<Guid>(type: "uuid", nullable: true),
                    OptionTitle = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedeemedByStaffId = table.Column<Guid>(type: "uuid", nullable: true),
                    QrCodeUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherValidity = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deals_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableQty = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistItems_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deals_ExpiresAt",
                table: "Deals",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_Deals_IsFeatured",
                table: "Deals",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_DealId",
                table: "Vouchers",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_ExpiresAt",
                table: "Vouchers",
                column: "ExpiresAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_DealId",
                table: "WishlistItems",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_UserId_DealId",
                table: "WishlistItems",
                columns: new[] { "UserId", "DealId" },
                unique: true);
        }
